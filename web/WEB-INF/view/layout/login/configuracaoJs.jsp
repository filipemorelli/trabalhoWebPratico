...
<!--  Scripts-->
<script src="<c:url value='/themes/theme1/bin/jquery-2.1.4.min.js' />"></script>
<script src="<c:url value='/themes/theme1/js/jquery.timeago.min.js' />"></script>
<script src="<c:url value='/themes/theme1/js/prism.js' />"></script>
