<%-- 
    Document   : floatButtonAdmin
    Created on : 05/09/2016, 16:30:40
    Author     : Filipe
--%>
...
<div class="fixed-action-btn" style="bottom: 25px; right: 25px;">
    ...
    <ul>
        ...
        <li><a href="pesquisar-carona" class="btn-floating orange tooltipped" data-position="left" data-tooltip="Pesquisar Caronas"><i class="material-icons">search</i></a></li>
