<div class="fixed-action-btn" style="bottom: 25px; right: 25px;">
    ...
    <ul>
        <li><a href="logout" class="btn-floating blue tooltipped" data-position="left" data-tooltip="Sair"><i class="material-icons">exit_to_app</i></a></li>
        <li><a href="#" class="btn-floating blue tooltipped" data-position="left" data-tooltip="Oferecer carona"><i class="material-icons">directions_car</i></a></li>
        <li><a href="#" class="btn-floating blue tooltipped" data-position="left" data-tooltip="Pedir carona"><i class="material-icons">event_seat</i></a></li>
        <li><a href="perfil" class="btn-floating blue tooltipped" data-position="left" data-tooltip="Perfil"><i class="material-icons">person</i></a></li>
    </ul>
</div>
<footer class="page-footer blue darken-3">
    <div class="container">
        <div class="row">
            ...
            <div class="col l4 s12">
                ...
                <p class="white-text">We have a Gitter chat room set up where you can talk directly with us. Come in and discuss new features, future goals, general problems or questions, or anything else you can think of.</p>
    ...
    <div class="footer-copyright">
        <div class="container">
            © 2016 JaVai, All rights reserved.
            <a class="white-text right" href="https://github.com/FilipeMorelli/trabalhoWebPratico/blob/master/license.md">MIT License</a>
        </div>
    </div>
</footer>