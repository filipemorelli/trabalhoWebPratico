    ...
    <body>
        ...
        <main>      
            <div class="section no-pad-bot blue darken-2" id="index-banner">
                <div class="container">
                    <h1 class="header center-on-small-only">Pedir Carona</h1>
                    <div class='row'>
            ...
            <div class="container">
                <div class="section">
                    <div class="row">
                        <form id="form-pedir-carona" class="col s12" method="POST">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col s12 m3 offset-m9">
                                    <button type="submit" class="btn btn-block blue waves-effect waves-light darken-2"><i class="material-icons right">send</i>Pedir Carona</button>
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCHMIcsEYQt1RoizBuH--1bWaWFNUcqM2I&signed_in=true&libraries=places&callback=PedirCarona.initAutocomplete" async defer></script>
        <script src="<c:url value='/themes/theme1/js/pedirCarona.js' />" charset="utf-8"></script>
    </body>
</html>
